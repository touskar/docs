...
class PayTech
{
    ...
    public function send()
    {
        ...
        $params = [
            ...
            'target_payment' => $this->targetPayment,
        ...
        if (array_key_exists('token', $jsonResponse)) {
            ...
            return [
                ...
                'redirectUrl' => $this::URL . $this::PAYMENT_REDIRECT_PATH . $jsonResponse['token'],
            ];
    ...
    {
        if (is_array($customeField) || is_object($customeField)) {
    ...
    public function setTargetPayment($targetPayment)
    {
