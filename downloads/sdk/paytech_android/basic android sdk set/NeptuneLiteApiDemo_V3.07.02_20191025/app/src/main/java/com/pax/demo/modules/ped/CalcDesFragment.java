...
public class CalcDesFragment extends BasePedFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textview.setText(getString(R.string.ped_input));
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                byte[] bytes = PedTester.getInstance(pedType).calcDes(
                        Convert.getInstance().strToBcd(str, EPaddingPosition.PADDING_RIGHT));
                if (bytes != null) {
                    writeview.setText(getString(R.string.ped_result_success)
